...
#define 	HEGrenadeOffset 		13	// (11 * 4)
#define 	FlashbangOffset 		14	// (12 * 4)
#define 	SmokegrenadeOffset		15	// (13 * 4)
#define		IncenderyGrenadesOffset	16	// (14 * 4) Also Molotovs
#define		DecoyGrenadeOffset		17	// (15 * 4)
...
public OnClientPostAdminCheck(client)
{
	...
	if (!IsFakeClient(client) && CheckCommandAccess(client, "gp2_csgo_vip", ADMFLAG_RESERVATION))
	{
